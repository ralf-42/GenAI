# SQL-Generierung Prompt Template
#
# Dieses Template übersetzt natürliche Sprachabfragen in korrekte SQL-Abfragen (SQLite-Syntax).
# Dabei werden – falls vorhanden – nicht nur die Ids, sondern auch die zugehörigen Bezeichnungen (z. B. Produktnamen, Kundennamen) mit ausgegeben.
#
# Verwendung:
#   from genai_lib.utilities import load_chat_prompt_template
#   template = load_chat_prompt_template("05_prompt/sql_generierung.py")
#   prompt = template.format_messages(schema="Datenbankschema hier einfügen", query="Deine Benutzeranfrage hier...")
