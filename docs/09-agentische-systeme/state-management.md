...
| [Wie erinnern sich Agenten über mehrere Schritte und Sitzungen hinweg?](../03-grundlagen/memory-systeme.html) | Wie wird aus dem laufenden State ein längerfristiges Gedächtnis? |

| [LangGraph Einsteiger](../06-frameworks/einsteiger-langgraph.html)                  | Wie wird State in konkreten LangGraph-Workflows verwendet?       |
