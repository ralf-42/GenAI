...
| [Tool Use & Function Calling]({{ '/09-agentische-systeme/tool-use-function-calling.html' | relative_url }}) | Wie werden Werkzeuge technisch beschrieben, aufgerufen und abgesichert? |
