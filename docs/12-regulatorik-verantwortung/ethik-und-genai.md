...
Für Projekte empfiehlt sich eine einfache Mindestprüfung: Zweck, betroffene Gruppen, Datenquellen, mögliche Schäden, menschliche Kontrolle und Evaluationskriterien werden vor der Umsetzung festgehalten. Nach der Umsetzung wird geprüft, ob das System in Grenzfällen, bei mehrdeutigen Prompts und bei sensiblen Inhalten stabil bleibt.
