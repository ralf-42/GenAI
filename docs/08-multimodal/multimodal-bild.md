...
| Dokument | Frage |
|---|---|
| [Multimodal Audio](./multimodal-audio.html) | Wie unterscheiden sich multimodale Muster, wenn statt Bildern Audio verarbeitet wird? |
| [Embeddings](../03-grundlagen/embeddings.html) | Wie werden Inhalte mathematisch vergleichbar gemacht? |
| [Modellauswahl](../04-modelle-provider/modellauswahl.html) | Welche Modellklasse passt zu welchem multimodalen Vorhaben? |
