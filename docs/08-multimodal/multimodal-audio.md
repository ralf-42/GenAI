...
| Dokument | Frage |
|---|---|
| [Multimodal Bild](./multimodal-bild.html) | Welche Parallelen und Unterschiede gibt es zwischen Bild- und Audioverarbeitung? |
| [Modellauswahl](../04-modelle-provider/modellauswahl.html) | Welche Modelle eignen sich für Audio-Aufgaben überhaupt? |
| [Context Engineering](../05-prompting-rag/context-engineering.html) | Wie wird Audio sinnvoll in den Gesamtkontext einer Anwendung eingebettet? |
