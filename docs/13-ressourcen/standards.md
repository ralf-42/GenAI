...
[LangChain Einsteiger](../06-frameworks/einsteiger-langchain.html) enthält das Tutorial mit ausführlichen Erklärungen und Mermaid-Diagrammen.
...
llm = ChatOpenAI(model="gpt-5.6-luna")  # Altbeispiel
...
- **LangChain Tutorial:** [LangChain Einsteiger](../06-frameworks/einsteiger-langchain.html)
...
> [!TIP] Vertiefung<br>
> Ausführliche LangChain-Beispiele mit Mermaid-Diagrammen stehen im Dokument [LangChain Einsteiger](../06-frameworks/einsteiger-langchain.html).
