...
- `genai_lib.model_config` - Zentrale Modellrollen wie `BASELINE`, `ROUTER`, `WORKER`, `CODING`, `JUDGE`, `PLANNER`, `WORKER_PREMIUM`, `FRONTIER`, `IMAGE_GENERATION` und `TRANSCRIPTION`
